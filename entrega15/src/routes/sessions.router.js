...
import {current,login,logout,register,getUsers,github,githubCallBack, uptadeRole, passwordLink, uptadePassword} from '../controllers/sessions.controller.js';
...
router.put('/premium/:id', uptadeRole);
