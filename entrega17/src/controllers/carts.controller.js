...
const addToCart = async (req, res) => {
  ...
  try {
    ...
    if((user.role === 'premium') && (product.owner === user.email)){
      req.logger.error('as a premium user, you cant add to your cart a product that you created');
      return res
        .status(400)
        .send({ status: "error", error: 'as a premium user, you cant add to your cart a product that you created' });
    };
