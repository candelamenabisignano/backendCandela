...
import { handlePolicies } from '../controllers/products.controller.js';
...
router.post('/', addCart);
router.post('/:cid/product/:pid', passport.authenticate('jwt', {session:false}), handlePolicies('user'), addToCart);
