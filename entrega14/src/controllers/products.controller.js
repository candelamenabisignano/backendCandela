...
const deleteProduct = async (req, res) => {
  ...
  try {
    ...
    if((user.role === 'premium') && (base.owner != user.email)){
      ...
      throw CustomError.createError({name:'error', message:'invalid credentials', cause:'you are not the owner of the product that you want to delete', code:EErrors.INVALID_CREDENTIALS});
    };
